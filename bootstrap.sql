INSERT INTO `spr18_csc429_enyst1`.`Book` (
  `bookId` ,
  `author` ,
  `title` ,
  `pubYear` ,
...
VALUES (NULL , 'J.R.R. Tolkien', 'The Lord of the Rings', '1954', 'active'),
  ...
  (NULL , 'Terry Pratchett', 'American Gods', '1968', 'active'),
...
INSERT INTO `spr18_csc429_enyst1`.`Patron` (
  `patronId`,
  `name`,
  `address`,
  `city`,
...
VALUES (NULL, 'Richard Dean Anderson', '124 Golin Lane', 'Minneapolis', 'MN', '95689', 'jack@sgc.com', '1950-01-23', 'active'),
